...
namespace KaizerWaldCode.PlayerEntityInteractions
{
    public class PlayerEntityInteractionInputsManager : MonoBehaviour
    {
        ...
        public InputAction SpaceEvents { get; private set; }
        //Selection Datas
        ...
        private void Awake()
        {
            ...
            SpaceEvents = Control.MouseControl.SpaceClick;
        }
        ...
        private void OnStartSpaceClick(InputAction.CallbackContext ctx) => SpaceClick = true;
        private void OnCancelSpaceClick(InputAction.CallbackContext ctx) => SpaceClick = false;
